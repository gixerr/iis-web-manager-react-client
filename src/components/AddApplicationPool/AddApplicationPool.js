    ...
    <div className={classes.addApplicationPoolForm}>
        ...
        <div>
            <div className={classes.applicationPoolField}>
                ...
                <select className={classes.applicationPoolSelect} onChange={newManagedRunTimeVersionHandler} value={newManagedRunTimeVersion}>
                    <option>v4.0</option>
                    <option>v2.0</option>
            ...
            <div className={classes.applicationPoolField}>
                ...
                <select className={classes.applicationPoolSelect} onChange={newManagedPipelineModeHandler} value={newManagedPipelineMode}>
            ...
            <div className={classes.applicationPoolButtons}>
                <button className={classes.addApplicationPoolSuccessButton} onClick={props.addClick.bind(null, generateNewApplicationPool())}>Add</button>
                <button className={classes.addApplicationPoolDangerButton} onClick={props.cancelClick}>Cancel</button>
            </div>
        </div>
    </div>
    )
